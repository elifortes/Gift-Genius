...
class QuestionsController < ApplicationController
  ...
  def param_strong
    params.require(:question).permit(:music, :answers, :favorites, :hobbies, :movie, :brands, :books, :restaurant, :games, :places, :devices, :purchases, :occasion_id, :user_id, :recipient, :myoccasion, :gift)
  end
